<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="归属单位" align="center" prop="orgId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="归属单位" prop="orgId">
          <el-input v-model="form.orgId" placeholder="请输入归属单位" />
        </el-form-item>
        <el-form-item label="归属部门" prop="deptId">
...
<script>
import { listUser, getUser, delUser, addUser, updateUser } from "@/api/ipms/user"
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('ipms/user/export', {
        ...this.queryParams
