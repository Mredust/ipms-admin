...
<script>
import { listRoom, getRoom, delRoom, addRoom, updateRoom } from "@/api/ipms/room"
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('ipms/room/export', {
        ...this.queryParams
