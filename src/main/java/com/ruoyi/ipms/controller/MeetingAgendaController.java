...
public class MeetingAgendaController extends BaseController
{
     ...
     * 查询会议议程列表
     */
    @PreAuthorize("@ss.hasPermi('ipms:agenda:list')")
    @GetMapping("/list")
     ...
     * 导出会议议程列表
     */
    @PreAuthorize("@ss.hasPermi('ipms:agenda:export')")
     ...
     * 获取会议议程详细信息
     */
    @PreAuthorize("@ss.hasPermi('ipms:agenda:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增会议议程
     */
    @PreAuthorize("@ss.hasPermi('ipms:agenda:add')")
     ...
     * 修改会议议程
     */
    @PreAuthorize("@ss.hasPermi('ipms:agenda:edit')")
     ...
     * 删除会议议程
     */
    @PreAuthorize("@ss.hasPermi('ipms:agenda:remove')")
